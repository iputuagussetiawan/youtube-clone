...
import { CheckIcon, CopyCheckIcon, CopyIcon, Globe2Icon, ImagePlusIcon, Loader2, Loader2Icon, LockIcon, MoreVerticalIcon, RotateCcw, RotateCcwIcon, SparkleIcon, TrashIcon } from 'lucide-react'
...
const FormSectionSuspense = ({videoId}:FormSectionProps) => {
    ...
    const restoreThumbnail=trpc.videos.restoreThumbnail.useMutation({
        ...
        onError: (error) => {
            toast   
            .error("Error restoring thumbnail for video", { description: error.message });
        }
    });
                                                ...
                                                <DropdownMenu>
                                                    <DropdownMenuTrigger asChild>
                                                        <Button
                                                            type='button'
                                                            size={"icon"}
                                                            className='absolute top-1 right-1 rounded-full opacity-100 md:opacity-0 group-hover:opacity-100 duration-300 size-7 bg-black/50 hover:bg-black/50'
                                                        >
                                        ...
                                        <div className='flex flex-col gap-y-1'>
                                            ...
                                            <div className='flex items-center gap-x-2'>
                                                <Link href={`/video/${video.id}`}>
                                                    <span className='line-clamp-1 text-sm text-blue-500'>
                                                        {fullUrl}
                                                    </span>
                                                </Link>
                                                <Button
                                                    ...
                                                    disabled={isCopied}
                                                >
                                                    {isCopied ? <CopyCheckIcon className='size-4 text-green-900'/> : <CopyIcon className='size-4'/>}
                                                </Button>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <SelectContent>
                                                    <SelectItem value="public">
                                                        <div className="flex item-center">
                                                            <Globe2Icon className="mr-1 h-4 w-4" />
                                                            Public
                                                        </div>
                                                    </SelectItem>
