...
const FormSectionSuspense = ({ videoId }: FormSectionProps) => {
    ...
    const restoreThumbnail = trpc.videos.restoreThumbnail.useMutation({
        ...
        onError: (error) => {
            toast.error("Error restoring thumbnail for video", {
    ...
    const generateTitle = trpc.videos.generateTitle.useMutation({
        ...
        onError: (error) => {
            toast.error("Error generating title for video", {
                description: error.message,
            });
        },
    });
    ...
    const generateDescription = trpc.videos.generateDescription.useMutation({
        ...
        onError: (error) => {
            toast.error("Error generating description for video", {
                description: error.message,
            });
        },
    });
    ...
    const generateThumbnail = trpc.videos.generateThumbnail.useMutation({
        ...
        onError: (error) => {
            toast.error("Error generating thumbnail for video", {
                description: error.message,
            });
        },
    });
                                    ...
                                    <div className="flex items-center justify-between gap-x-2">
                                        <div className="flex flex-col gap-y-1">
                                            ...
                                            <div className="flex items-center gap-x-2">
                                                ...
                                                >
                                                    {isCopied ? (
                                                        <CopyCheckIcon className="size-4 text-green-900" />
                                                    ) : (
